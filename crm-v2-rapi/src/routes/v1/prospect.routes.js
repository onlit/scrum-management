 ...
 * CRUD operations related to prospect. It imports middleware functions for authentication,
 * authorization, and error handling, as well as controller functions for handling specific
 * CRUD operations on prospect.
 *
...
} = require('#controllers/prospect.controller.js');
...
router.get('/', auth, wrapExpressAsync(getAllProspect, 'prospect_get_all'));
