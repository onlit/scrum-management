 ...
 * CRUD operations related to opportunityHistory. It imports middleware functions for authentication,
 * authorization, and error handling, as well as controller functions for handling specific
 * CRUD operations on opportunityHistory.
 *
...
router.put(
  ...
  auth,
  protect,
  wrapExpressAsync(updateOpportunityHistory, 'opportunity_history_update_put'),
);
