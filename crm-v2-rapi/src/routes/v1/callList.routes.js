 ...
 * CRUD operations related to callList. It imports middleware functions for authentication,
 * authorization, and error handling, as well as controller functions for handling specific
 * CRUD operations on callList.
 *
...
router.get('/', auth, wrapExpressAsync(getAllCallList, 'call_list_get_all'));
...
router.get('/:id', auth, wrapExpressAsync(getCallList, 'call_list_get_by_id'));
