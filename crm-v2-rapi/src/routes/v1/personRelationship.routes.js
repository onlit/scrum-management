 ...
 * CRUD operations related to personRelationship. It imports middleware functions for authentication,
 * authorization, and error handling, as well as controller functions for handling specific
 * CRUD operations on personRelationship.
 *
...
router.put(
  ...
  auth,
  protect,
  wrapExpressAsync(updatePersonRelationship, 'person_relationship_update_put'),
);
