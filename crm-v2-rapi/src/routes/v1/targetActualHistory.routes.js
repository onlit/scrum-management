 ...
 * CRUD operations related to targetActualHistory. It imports middleware functions for authentication,
 * authorization, and error handling, as well as controller functions for handling specific
 * CRUD operations on targetActualHistory.
 *
...
router.get(
  '/',
  auth,
  wrapExpressAsync(getAllTargetActualHistory, 'target_actual_history_get_all'),
);
