...
const {
  ...
  getAllTargetActualHistorys,
  getTargetActualHistory,
  updateTargetActualHistory,
  deleteTargetActualHistory,
} = require('#controllers/targetActualHistory.controller.js');
...
describe('createTargetActualHistory', () => {
  ...
  it('should successfully create a targetActualHistory and return status 201 with the created object', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(mockTargetActualHistoryData); // Check if the created targetActualHistory data was returned in the response
...
// Defines a test suite for the `getAllTargetActualHistorys` function.
describe('getAllTargetActualHistorys', () => {
  ...
  it('successfully retrieves targetActualHistorys', async () => {
    ...
    // Invoke the `getAllTargetActualHistorys` function with the mocked request and response objects.
    await getAllTargetActualHistorys(req, res, next);
...
describe('getTargetActualHistory', () => {
  ...
  it('should successfully retrieve a targetActualHistory and return status 200 with the targetActualHistory data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body is the mock targetActualHistory data.
    expect(res.json).toHaveBeenCalledWith(mockTargetActualHistoryData);
  });
...
describe('updateTargetActualHistory', () => {
  ...
  it('should successfully update a targetActualHistory and return status 200 with the updated targetActualHistory data', async () => {
    ...
    const mockRequestBody = {
      name: 'Updated TargetActualHistory',
      version: '2.0.0',
    };
    ...
    // Mock the Prisma update operation to resolve with the updated targetActualHistory data.
    prisma.targetActualHistory.update.mockResolvedValue(
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.json).toHaveBeenCalledWith(mockUpdatedTargetActualHistory);
    // Verify that the Prisma update method was called with the correct parameters.
    expect(prisma.targetActualHistory.update).toHaveBeenCalledWith({
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.targetActualHistory.update.mockRejectedValue(databaseError);
  ...
  it('transforms request body keys to camelCase before updating', async () => {
    ...
    // Mock the Prisma update operation to resolve with the updated targetActualHistory data, including transformed keys.
    prisma.targetActualHistory.update.mockResolvedValue({
      id,
...
describe('deleteTargetActualHistory', () => {
  ...
  it('should successfully delete a targetActualHistory and return status 200 with the deleted ID', async () => {
    ...
    // Mock ID representing the creator of the targetActualHistory, used for authorization.
    ...
    prisma.targetActualHistory.deleteMany.mockResolvedValue({ count: 1 });
    ...
    // including the ID of the targetActualHistory to delete and the creator's ID for authorization.
    expect(prisma.targetActualHistory.deleteMany).toHaveBeenCalledWith({
