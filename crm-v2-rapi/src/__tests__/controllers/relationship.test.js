...
describe('createRelationship', () => {
  ...
  it('should successfully create a relationship and return status 201 with the created object', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(mockRelationshipData); // Check if the created relationship data was returned in the response
...
// Defines a test suite for the `getAllRelationships` function.
describe('getAllRelationships', () => {
  ...
  it('successfully retrieves relationships', async () => {
    ...
    // Invoke the `getAllRelationships` function with the mocked request and response objects.
    await getAllRelationships(req, res, next);
...
describe('getRelationship', () => {
  ...
  it('should successfully retrieve a relationship and return status 200 with the relationship data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body is the mock relationship data.
    expect(res.json).toHaveBeenCalledWith(mockRelationshipData);
  });
...
describe('updateRelationship', () => {
  ...
  it('should successfully update a relationship and return status 200 with the updated relationship data', async () => {
    ...
    const mockRequestBody = { name: 'Updated Relationship', version: '2.0.0' };
    // The expected result after updating the relationship.
    const mockUpdatedRelationship = { ...mockRequestBody, id: mockParamsId };

    // Mock the Prisma update operation to resolve with the updated relationship data.
    prisma.relationship.update.mockResolvedValue(mockUpdatedRelationship);
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.json).toHaveBeenCalledWith(mockUpdatedRelationship);
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.relationship.update.mockRejectedValue(databaseError);
  ...
  it('transforms request body keys to camelCase before updating', async () => {
    ...
    // Mock the Prisma update operation to resolve with the updated relationship data, including transformed keys.
...
describe('deleteRelationship', () => {
  ...
  it('should successfully delete a relationship and return status 200 with the deleted ID', async () => {
    ...
    // Mock ID representing the creator of the relationship, used for authorization.
    ...
    prisma.relationship.deleteMany.mockResolvedValue({ count: 1 });
    ...
    // including the ID of the relationship to delete and the creator's ID for authorization.
