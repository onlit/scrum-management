...
describe('createPerson', () => {
  ...
  it('should successfully create a person and return status 201 with the created object', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(mockPersonData); // Check if the created person data was returned in the response
...
// Defines a test suite for the `getAllPersons` function.
describe('getAllPersons', () => {
  ...
  it('successfully retrieves persons', async () => {
    ...
    // Invoke the `getAllPersons` function with the mocked request and response objects.
    await getAllPersons(req, res, next);
...
describe('getPerson', () => {
  ...
  it('should successfully retrieve a person and return status 200 with the person data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body is the mock person data.
    expect(res.json).toHaveBeenCalledWith(mockPersonData);
  });
  ...
  it('should return a 404 error if the person is not found', async () => {
    ...
    await expect(getPerson(req, res, next)).rejects.toThrow('Person not found');
  });
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    await expect(getPerson(req, res, next)).rejects.toThrow('Database error');
  });
});
...
describe('updatePerson', () => {
  ...
  it('should successfully update a person and return status 200 with the updated person data', async () => {
    ...
    const mockRequestBody = { name: 'Updated Person', version: '2.0.0' };
    // The expected result after updating the person.
    const mockUpdatedPerson = { ...mockRequestBody, id: mockParamsId };

    // Mock the Prisma update operation to resolve with the updated person data.
    prisma.person.update.mockResolvedValue(mockUpdatedPerson);
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.json).toHaveBeenCalledWith(mockUpdatedPerson);
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.person.update.mockRejectedValue(databaseError);
    ...
    await expect(updatePerson(req, {}, next)).rejects.toThrow('Database error');
  });
  ...
  it('transforms request body keys to camelCase before updating', async () => {
    ...
    // Mock the Prisma update operation to resolve with the updated person data, including transformed keys.
...
describe('deletePerson', () => {
  ...
  it('should successfully delete a person and return status 200 with the deleted ID', async () => {
    ...
    // Mock ID representing the creator of the person, used for authorization.
    ...
    prisma.person.deleteMany.mockResolvedValue({ count: 1 });
    ...
    // including the ID of the person to delete and the creator's ID for authorization.
