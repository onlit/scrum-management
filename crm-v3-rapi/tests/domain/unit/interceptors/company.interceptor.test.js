/**
 * Company Interceptor Tests
 *
 * Tests for Company model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/company.interceptor.test
 */
...
// const companyInterceptor = require('#domain/interceptors/company.interceptor.js');

describe('Company Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('Company', companyInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('Company');
