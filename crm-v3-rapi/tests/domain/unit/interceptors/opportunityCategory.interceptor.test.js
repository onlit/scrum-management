/**
 * OpportunityCategory Interceptor Tests
 *
 * Tests for OpportunityCategory model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/opportunityCategory.interceptor.test
 */
...
// const opportunityCategoryInterceptor = require('#domain/interceptors/opportunityCategory.interceptor.js');

describe('OpportunityCategory Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('OpportunityCategory', opportunityCategoryInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('OpportunityCategory');
