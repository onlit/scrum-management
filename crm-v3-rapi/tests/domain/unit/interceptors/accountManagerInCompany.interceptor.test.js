/**
 * AccountManagerInCompany Interceptor Tests
 *
 * Tests for AccountManagerInCompany model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/accountManagerInCompany.interceptor.test
 */
...
// const accountManagerInCompanyInterceptor = require('#domain/interceptors/accountManagerInCompany.interceptor.js');

describe('AccountManagerInCompany Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('AccountManagerInCompany', accountManagerInCompanyInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('AccountManagerInCompany');
