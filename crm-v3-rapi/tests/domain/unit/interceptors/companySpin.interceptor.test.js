/**
 * CompanySpin Interceptor Tests
 *
 * Tests for CompanySpin model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/companySpin.interceptor.test
 */
...
// const companySpinInterceptor = require('#domain/interceptors/companySpin.interceptor.js');

describe('CompanySpin Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('CompanySpin', companySpinInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('CompanySpin');
