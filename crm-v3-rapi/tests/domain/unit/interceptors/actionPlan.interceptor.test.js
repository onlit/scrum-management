/**
 * ActionPlan Interceptor Tests
 *
 * Tests for ActionPlan model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/actionPlan.interceptor.test
 */
...
// const actionPlanInterceptor = require('#domain/interceptors/actionPlan.interceptor.js');

describe('ActionPlan Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('ActionPlan', actionPlanInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('ActionPlan');
