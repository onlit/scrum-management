/**
 * Person Interceptor Tests
 *
 * Tests for Person model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/person.interceptor.test
 */
...
// const personInterceptor = require('#domain/interceptors/person.interceptor.js');

describe('Person Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('Person', personInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('Person');
