/**
 * CompanyInTerritory Interceptor Tests
 *
 * Tests for CompanyInTerritory model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/companyInTerritory.interceptor.test
 */
...
// const companyInTerritoryInterceptor = require('#domain/interceptors/companyInTerritory.interceptor.js');

describe('CompanyInTerritory Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('CompanyInTerritory', companyInTerritoryInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('CompanyInTerritory');
