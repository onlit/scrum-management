/**
 * CompanySocialMedia Interceptor Tests
 *
 * Tests for CompanySocialMedia model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/companySocialMedia.interceptor.test
 */
...
// const companySocialMediaInterceptor = require('#domain/interceptors/companySocialMedia.interceptor.js');

describe('CompanySocialMedia Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('CompanySocialMedia', companySocialMediaInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('CompanySocialMedia');
