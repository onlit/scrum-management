/**
 * PersonHistory Interceptor Tests
 *
 * Tests for PersonHistory model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/personHistory.interceptor.test
 */
...
// const personHistoryInterceptor = require('#domain/interceptors/personHistory.interceptor.js');

describe('PersonHistory Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('PersonHistory', personHistoryInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('PersonHistory');
