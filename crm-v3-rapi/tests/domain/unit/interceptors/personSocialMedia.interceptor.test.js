/**
 * PersonSocialMedia Interceptor Tests
 *
 * Tests for PersonSocialMedia model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/personSocialMedia.interceptor.test
 */
...
// const personSocialMediaInterceptor = require('#domain/interceptors/personSocialMedia.interceptor.js');

describe('PersonSocialMedia Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('PersonSocialMedia', personSocialMediaInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('PersonSocialMedia');
