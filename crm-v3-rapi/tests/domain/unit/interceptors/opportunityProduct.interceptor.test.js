/**
 * OpportunityProduct Interceptor Tests
 *
 * Tests for OpportunityProduct model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/opportunityProduct.interceptor.test
 */
...
// const opportunityProductInterceptor = require('#domain/interceptors/opportunityProduct.interceptor.js');

describe('OpportunityProduct Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('OpportunityProduct', opportunityProductInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('OpportunityProduct');
