/**
 * DataNeeded Interceptor Tests
 *
 * Tests for DataNeeded model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/dataNeeded.interceptor.test
 */
...
// const dataNeededInterceptor = require('#domain/interceptors/dataNeeded.interceptor.js');

describe('DataNeeded Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('DataNeeded', dataNeededInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('DataNeeded');
