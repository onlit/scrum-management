/**
 * CallList Interceptor Tests
 *
 * Tests for CallList model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/callList.interceptor.test
 */
...
// const callListInterceptor = require('#domain/interceptors/callList.interceptor.js');

describe('CallList Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('CallList', callListInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('CallList');
