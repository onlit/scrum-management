/**
 * PersonRelationship Interceptor Tests
 *
 * Tests for PersonRelationship model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/personRelationship.interceptor.test
 */
...
// const personRelationshipInterceptor = require('#domain/interceptors/personRelationship.interceptor.js');

describe('PersonRelationship Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('PersonRelationship', personRelationshipInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('PersonRelationship');
