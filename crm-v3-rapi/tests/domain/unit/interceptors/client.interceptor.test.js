 ...
 *
 * Tests for Client model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/client.interceptor.test
 */
...
// const clientInterceptor = require('#domain/interceptors/client.interceptor.js');
...
describe('Client Interceptor', () => {
  ...
  beforeEach(() => {
    ...
    // registry.register('Client', clientInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('Client');
