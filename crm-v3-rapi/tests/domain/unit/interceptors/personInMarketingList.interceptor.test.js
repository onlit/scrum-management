/**
 * PersonInMarketingList Interceptor Tests
 *
 * Tests for PersonInMarketingList model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/personInMarketingList.interceptor.test
 */
...
// const personInMarketingListInterceptor = require('#domain/interceptors/personInMarketingList.interceptor.js');

describe('PersonInMarketingList Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('PersonInMarketingList', personInMarketingListInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('PersonInMarketingList');
