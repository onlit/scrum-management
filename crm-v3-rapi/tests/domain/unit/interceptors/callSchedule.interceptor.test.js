/**
 * CallSchedule Interceptor Tests
 *
 * Tests for CallSchedule model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/callSchedule.interceptor.test
 */
...
// const callScheduleInterceptor = require('#domain/interceptors/callSchedule.interceptor.js');

describe('CallSchedule Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('CallSchedule', callScheduleInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('CallSchedule');
