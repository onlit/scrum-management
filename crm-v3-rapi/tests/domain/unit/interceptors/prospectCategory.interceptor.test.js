/**
 * ProspectCategory Interceptor Tests
 *
 * Tests for ProspectCategory model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/prospectCategory.interceptor.test
 */
...
// const prospectCategoryInterceptor = require('#domain/interceptors/prospectCategory.interceptor.js');

describe('ProspectCategory Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('ProspectCategory', prospectCategoryInterceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('ProspectCategory');
