...
describe('createCustomerEnquiryPurpose', () => {
  ...
  it('should successfully create a customerEnquiryPurpose and return status 201 with the created object', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockCustomerEnquiryPurposeData),
    ); // Check if the created customerEnquiryPurpose data was returned in the response
...
// Defines a test suite for the `getAllCustomerEnquiryPurpose` function.
describe('getAllCustomerEnquiryPurpose', () => {
  ...
  it('successfully retrieves customerEnquiryPurposes', async () => {
    ...
    // Invoke the `getAllCustomerEnquiryPurpose` function with the mocked request and response objects.
    await getAllCustomerEnquiryPurpose(req, res, next);
...
describe('getCustomerEnquiryPurpose', () => {
  ...
  it('should successfully retrieve a customerEnquiryPurpose and return status 200 with the customerEnquiryPurpose data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body contains the mock customerEnquiryPurpose data.
    // Controller enriches response with __displayValue and details, so use objectContaining.
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockCustomerEnquiryPurposeData),
    );
...
describe('updateCustomerEnquiryPurpose', () => {
  ...
  it('should successfully update a customerEnquiryPurpose and return status 200 with the updated customerEnquiryPurpose data', async () => {
    ...
    prisma.customerEnquiryPurpose.updateMany.mockResolvedValue({
      count: 1,
    });
    ...
    expect(prisma.customerEnquiryPurpose.updateMany).toHaveBeenCalled();
  });
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.customerEnquiryPurpose.updateMany.mockRejectedValue(databaseError);
