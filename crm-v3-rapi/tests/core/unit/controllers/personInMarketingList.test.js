...
describe('createPersonInMarketingList', () => {
  ...
  it('should successfully create a personInMarketingList and return status 201 with the created object', async () => {
    ...
    const mockPersonInMarketingListData = {
      personId: 'd8d47913-1b54-4f21-87bc-1f72d1d89f89',
      marketingListId: 'd8d47913-1b54-4f21-87bc-1f72d1d89f89',
    };
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockPersonInMarketingListData),
    ); // Check if the created personInMarketingList data was returned in the response
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    await expect(createPersonInMarketingList(req, res, next)).rejects.toThrow(); // Controller wraps errors, so just check that it throws
  });
});

// Defines a test suite for the `getAllPersonInMarketingList` function.
describe('getAllPersonInMarketingList', () => {
  ...
  it('successfully retrieves personInMarketingLists', async () => {
    ...
    // Invoke the `getAllPersonInMarketingList` function with the mocked request and response objects.
    await getAllPersonInMarketingList(req, res, next);
...
describe('getPersonInMarketingList', () => {
  ...
  it('should successfully retrieve a personInMarketingList and return status 200 with the personInMarketingList data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body contains the mock personInMarketingList data.
    // Controller enriches response with __displayValue and details, so use objectContaining.
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockPersonInMarketingListData),
    );
...
describe('updatePersonInMarketingList', () => {
  ...
  it('should successfully update a personInMarketingList and return status 200 with the updated personInMarketingList data', async () => {
    ...
    prisma.personInMarketingList.updateMany.mockResolvedValue({
      count: 1,
    });
    ...
    expect(prisma.personInMarketingList.updateMany).toHaveBeenCalled();
  });
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.personInMarketingList.updateMany.mockRejectedValue(databaseError);
