...
describe('createOnlineSignup', () => {
  ...
  it('should successfully create a onlineSignup and return status 201 with the created object', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockOnlineSignupData),
    ); // Check if the created onlineSignup data was returned in the response
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    await expect(createOnlineSignup(req, res, next)).rejects.toThrow(); // Controller wraps errors, so just check that it throws
  });
});

// Defines a test suite for the `getAllOnlineSignup` function.
describe('getAllOnlineSignup', () => {
  ...
  it('successfully retrieves onlineSignups', async () => {
    ...
    // Invoke the `getAllOnlineSignup` function with the mocked request and response objects.
    await getAllOnlineSignup(req, res, next);
...
describe('getOnlineSignup', () => {
  ...
  it('should successfully retrieve a onlineSignup and return status 200 with the onlineSignup data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body contains the mock onlineSignup data.
    // Controller enriches response with __displayValue and details, so use objectContaining.
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockOnlineSignupData),
    );
...
describe('updateOnlineSignup', () => {
  ...
  it('should successfully update a onlineSignup and return status 200 with the updated onlineSignup data', async () => {
    ...
    expect(prisma.onlineSignup.updateMany).toHaveBeenCalled();
  });
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.onlineSignup.updateMany.mockRejectedValue(databaseError);
  ...
  it('transforms request body keys to camelCase before updating', async () => {
    ...
    prisma.onlineSignup.findFirst.mockResolvedValue({
      id,
