...
describe('createCompanyHistory', () => {
  ...
  it('should successfully create a companyHistory and return status 201 with the created object', async () => {
    ...
    const mockCompanyHistoryData = {
      ...
      history: 'd_compute_test_history',
    };
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockCompanyHistoryData),
    ); // Check if the created companyHistory data was returned in the response
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    await expect(createCompanyHistory(req, res, next)).rejects.toThrow(); // Controller wraps errors, so just check that it throws
  });
});

// Defines a test suite for the `getAllCompanyHistory` function.
describe('getAllCompanyHistory', () => {
  ...
  it('successfully retrieves companyHistorys', async () => {
    ...
    // Invoke the `getAllCompanyHistory` function with the mocked request and response objects.
    await getAllCompanyHistory(req, res, next);
...
describe('getCompanyHistory', () => {
  ...
  it('should successfully retrieve a companyHistory and return status 200 with the companyHistory data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body contains the mock companyHistory data.
    // Controller enriches response with __displayValue and details, so use objectContaining.
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockCompanyHistoryData),
    );
...
describe('updateCompanyHistory', () => {
  ...
  it('should successfully update a companyHistory and return status 200 with the updated companyHistory data', async () => {
    ...
    expect(prisma.companyHistory.updateMany).toHaveBeenCalled();
  });
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.companyHistory.updateMany.mockRejectedValue(databaseError);
