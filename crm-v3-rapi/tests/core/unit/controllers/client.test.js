...
describe('createClient', () => {
  ...
  it('should successfully create a client and return status 201 with the created object', async () => {
    ...
    ); // Check if the created client data was returned in the response
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    await expect(createClient(req, res, next)).rejects.toThrow(); // Controller wraps errors, so just check that it throws
  });
});

// Defines a test suite for the `getAllClient` function.
describe('getAllClient', () => {
  ...
  it('successfully retrieves clients', async () => {
    ...
    // Invoke the `getAllClient` function with the mocked request and response objects.
    await getAllClient(req, res, next);
...
describe('getClient', () => {
  ...
  it('should successfully retrieve a client and return status 200 with the client data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body contains the mock client data.
    // Controller enriches response with __displayValue and details, so use objectContaining.
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockClientData),
    );
  ...
  it('should return a 404 error if the client is not found', async () => {
    ...
    await expect(getClient(req, res, next)).rejects.toThrow();
  });
...
describe('updateClient', () => {
  ...
  it('should successfully update a client and return status 200 with the updated client data', async () => {
    ...
    prisma.client.findFirst.mockResolvedValue(mockUpdatedClient);
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.client.updateMany.mockRejectedValue(databaseError);
    ...
    await expect(updateClient(req, {}, next)).rejects.toThrow();
  });
...
describe('deleteClient', () => {
  ...
  it('should successfully delete a client and return status 200 with the deleted ID', async () => {
    ...
    prisma.clientHistory.updateMany.mockResolvedValue({ count: 0 });
