...
describe('createCompanyContact', () => {
  ...
  it('should successfully create a companyContact and return status 201 with the created object', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockCompanyContactData),
    ); // Check if the created companyContact data was returned in the response
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    await expect(createCompanyContact(req, res, next)).rejects.toThrow(); // Controller wraps errors, so just check that it throws
  });
});

// Defines a test suite for the `getAllCompanyContact` function.
describe('getAllCompanyContact', () => {
  ...
  it('successfully retrieves companyContacts', async () => {
    ...
    // Invoke the `getAllCompanyContact` function with the mocked request and response objects.
    await getAllCompanyContact(req, res, next);
...
describe('getCompanyContact', () => {
  ...
  it('should successfully retrieve a companyContact and return status 200 with the companyContact data', async () => {
    ...
    expect(res.status).toHaveBeenCalledWith(200);
    // Assert the response body contains the mock companyContact data.
    // Controller enriches response with __displayValue and details, so use objectContaining.
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining(mockCompanyContactData),
    );
...
describe('updateCompanyContact', () => {
  ...
  it('should successfully update a companyContact and return status 200 with the updated companyContact data', async () => {
    ...
    expect(prisma.companyContact.updateMany).toHaveBeenCalled();
  });
  ...
  it('throws an error if the database operation fails', async () => {
    ...
    prisma.companyContact.updateMany.mockRejectedValue(databaseError);
...
describe('deleteCompanyContact', () => {
  ...
  it('should successfully delete a companyContact and return status 200 with the deleted ID', async () => {
    ...
    prisma.opportunityInfluencer.updateMany.mockResolvedValue({ count: 0 });
