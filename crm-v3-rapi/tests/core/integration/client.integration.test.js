...
describe('Client Integration Tests', () => {
  ...
  describe('POST /api/v1/clients - Create', () => {
    it('should create a new Client and persist to database', async () => {
      ...
      const dbRecord = await prisma.client.findUnique({
  ...
  describe('GET /api/v1/clients - List', () => {
    ...
    it('should support pagination parameters', async () => {
      ...
      const response = await request(server)
        .get('/api/v1/clients?page=1&perPage=2')
        .set(authHeaders)
        .expect(200);
  ...
  describe('GET /api/v1/clients/:id - Get One', () => {
  ...
  describe('PUT /api/v1/clients/:id - Update', () => {
  ...
  describe('DELETE /api/v1/clients/:id - Delete', () => {
