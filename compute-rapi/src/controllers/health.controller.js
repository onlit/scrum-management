...
async function getReadiness(req, res) {
  ...
  const REDIS_TIMEOUT_MS = Number(process.env.READINESS_REDIS_TIMEOUT_MS || 2000);
  const OVERALL_TIMEOUT_MS = Number(process.env.READINESS_OVERALL_TIMEOUT_MS || 5000);
