 ...
 *
 * This middleware provides comprehensive security monitoring with:
 * - Anti-spoofing IP validation
 * - Safe threat detection (ReDoS resistant)
 * - Memory-efficient failed attempt tracking
