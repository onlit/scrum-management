/**
 * @gen{MODEL_NAME|Pascal} Filter Extensions
 *
 * Custom filter fields and handlers for the @gen{MODEL_NAME|Pascal} model.
 ...
 * };
 *
 * @module domain/extensions/@gen{MODEL_NAME|camel}.filters
 */
