/**
 * @gen{MODEL_NAME|Pascal} Interceptor Tests
 *
 * Tests for @gen{MODEL_NAME|Pascal} model lifecycle hooks.
 * This file is PROTECTED - never overwritten by the generator.
 *
 * @module tests/domain/interceptors/@gen{MODEL_NAME|camel}.interceptor.test
 */
...
// const @gen{MODEL_NAME|camel}Interceptor = require('#domain/interceptors/@gen{MODEL_NAME|camel}.interceptor.js');

describe('@gen{MODEL_NAME|Pascal} Interceptor', () => {
  let registry;

  beforeEach(() => {
    registry = new InterceptorRegistry();
    // Uncomment to register your interceptor:
    // registry.register('@gen{MODEL_NAME|Pascal}', @gen{MODEL_NAME|camel}Interceptor);
  });
  ...
  describe('Validation Phase', () => {
    ...
    //   const interceptor = registry.resolve('@gen{MODEL_NAME|Pascal}');
